...
<dl>
  ...
  <dd>The calculator throws IllegalArgumentException whenever there's negative price or null array is supplied. Zero priced items are still allowed, an empty array will return zero.</dd>
  <dt>Test Cases</dt>
